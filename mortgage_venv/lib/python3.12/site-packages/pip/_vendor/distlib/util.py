...
def get_resources_dests(resources_root, rules):
    """Find destinations for src files"""
...
class Cache(object):
    """
    A class implementing a cache for src that need to live in the file system
    e.g. shared libraries. This class was moved from src to here because it
